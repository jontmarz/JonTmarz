...
const TributosCoNavbar: React.FC = () => {
    const navigate = useNavigate()
    const { t } = useTranslation('TributosCo')
    const [scroll, setScroll] = useState(false)
    const [mobileMenuOpen, setMobileMenuOpen] = useState(false)
    
    const menuItems = useMemo(() => createMenus(t).tributosCo, [t])
        ...
        <>
            <AppBar
                ...
                sx={{
                    ...
                    borderBottom: scroll ? '1px solid rgba(147, 51, 234, 0.2)' : '1px solid transparent',
                }}
            >
...
export default TributosCoNavbar
