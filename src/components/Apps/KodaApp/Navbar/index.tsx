...
const KodaAppNavbar: React.FC = () => {
    const navigate = useNavigate()
    const { t } = useTranslation('KodaApp')
    const [scroll, setScroll] = useState(false)
    const [mobileMenuOpen, setMobileMenuOpen] = useState(false)
    
    const menuItems = useMemo(() => createMenus(t).kodaApp, [t])
        ...
        <>
            <AppBar
                ...
                sx={{
                    ...
                    borderBottom: scroll ? '1px solid rgba(0, 170, 255, 0.2)' : '1px solid transparent',
                }}
            >
